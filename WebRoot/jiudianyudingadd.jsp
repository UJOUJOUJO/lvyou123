                      ...
                      <tr>
                        ...
                        <td width="733" height="183" valign="top"><form name="form1" method="post" action="jiudianyuding_add_post.jsp">
                          <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">
                            <tr>
                              <td>酒店名称：</td>
                              <td><input name='jiudianmingcheng' type='text' id='jiudianmingcheng' value='<%=new String(request.getParameter("jd").getBytes("8859_1"))%>' size='50' />
                                &nbsp;*</td>
                            </tr>
                            <tr>
                              <td>客房编号：</td>
                            ...
                            <tr>
                              <td>预订时间：</td>
                              <td><input name='yudingshijian' type='text' id='yudingshijian' value='' readonly='readonly' onClick="getDate(document.form1.yudingshijian,'2')" need='1' />
                                &nbsp;*</td>
                            </tr>
                            <tr>
                              <td>预订天数：</td>
