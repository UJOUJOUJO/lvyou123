...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  ...
  zys=zgs/page_record+1;
   ...
   sql="";
  sql="select top "+page_record+" * from jiudianyuding where yonghuming='"+request.getSession().getAttribute("username")+"' and id not in (select top "+((curpage-1)*page_record)+" id from jiudianyuding where yonghuming='"+request.getSession().getAttribute("username")+"' order by id desc) ";
