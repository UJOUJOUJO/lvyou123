...
function gow()
{
  ...
  添加酒店预订:
  <br><br>
   <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">    <tr><td>酒店名称：</td><td><input name='jiudianmingcheng' type='text' id='jiudianmingcheng' value='' size='50' />&nbsp;*</td></tr><tr><td>客房编号：</td><td><input name='kefangbianhao' type='text' id='kefangbianhao' value='' />&nbsp;*</td></tr><tr><td>价格：</td><td><input name='jiage' type='text' id='jiage' value='' />&nbsp;*</td></tr><tr><td>预订时间：</td><td><input name='yudingshijian' type='text' id='yudingshijian' value='' readonly='readonly' onClick="getDate(document.form1.yudingshijian,'2')" need='1' />&nbsp;*</td></tr><tr><td>预订天数：</td><td><input name='yudingtianshu' type='text' id='yudingtianshu' value='' />&nbsp;*</td></tr><tr><td>您的姓名：</td><td><input name='nindexingming' type='text' id='nindexingming' value='' />&nbsp;*</td></tr><tr><td>您的电话：</td><td><input name='nindedianhua' type='text' id='nindedianhua' value='' />&nbsp;*</td></tr><tr><td>您的身份证：</td><td><input name='nindeshenfenzheng' type='text' id='nindeshenfenzheng' value='' size='50' />&nbsp;*</td></tr><tr><td>备注：</td><td><textarea name='beizhu' cols='50' rows='5' id='beizhu'></textarea></td></tr><tr><td>用户名：</td><td><input name='yonghuming' type='text' id='yonghuming' value='<%=request.getSession().getAttribute("username")%>' />&nbsp;*</td></tr>
    <tr>
      <td>&nbsp;</td>
