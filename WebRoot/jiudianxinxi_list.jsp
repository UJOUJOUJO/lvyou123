...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  ...
  zys=zgs/page_record+1;
   ...
   sql="";
  sql="select top "+page_record+" * from jiudianxinxi where id not in (select top "+((curpage-1)*page_record)+" id from jiudianxinxi order by id desc) ";
...
%>
  <tr>
    ...
    <td width="90" align="center"><a href="kefang_list.jsp?jd=<%=mingcheng%>">客房管理</a></td>
