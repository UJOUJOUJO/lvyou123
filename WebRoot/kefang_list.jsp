...
String sql;
ResultSet RS_result;
String jd=new String(request.getParameter("jd").getBytes("8859_1"));
%>
  <body >
  <p>已有客房列表：</p>
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  ...
  int curpage=1;//当前页
				...
				String fysql="select count(id) as ss from kefang where jiudian='"+jd+"'";
  ...
  zys=zgs/page_record+1;
   ...
   sql="";
  sql="select top "+page_record+" * from kefang where jiudian='"+jd+"' and id not in (select top "+((curpage-1)*page_record)+" id from kefang where jiudian='"+jd+"' order by id desc) ";
