...
function gow()
{
  ...
  添加客房:
  <br><br>
   <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">    <tr><td>酒店：</td><td><input name='jiudian' type='text' id='jiudian' value='<%=new String(request.getParameter("jd").getBytes("8859_1"))%>' size='50' />&nbsp;*</td></tr><tr><td>客房编号：</td><td><input name='kefangbianhao' type='text' id='kefangbianhao' value='' />&nbsp;*</td></tr><tr><td>类型：</td><td><select name='leixing' id='leixing'>
